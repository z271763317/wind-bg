		...
		$(document).ready(function(){
			...
			var tableConfig={
				cols: [[
					...
					,{field:'code', title: '代码'}
					,{field:'name', title: '名称'}
					,{field:'status', title: '状态',toolbar:'#bar_status',width:60}
					,{field:'protocol', title: '协议',width:80}
					,{field:'domain', title: '域名'}
					,{field:'server', title: '系统名'}
					,{field:'intranetIp', title: '内网IP'}
					,{field:'port', title: '端口'}
...
<body>
	<div>
		...
		<div style="padding:0px 10px;font-size:12px;color:#7A7A7A;line-height:22px">
			<div><b style="color:red">说明</b>：作用于【权限管理】，若不设置，则是当前系统的模块。由：【协议+域名+系统名】组合成1个系统的链接，在拼接【访问url】形成一个完整的请求链接</div>
		</div>
		<!-- 列表数据 -->
